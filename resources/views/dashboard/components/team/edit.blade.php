                ...
                <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 company-logo">
                            ...
                            <img class="rounded" src="{{ Storage::url($team->photo) }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" name="ig_link" id="ig_link"
                                class="form-control @error('ig_link') is-invalid @enderror" value="{{ $team->ig_link }}"
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" name="fb_link" id="fb_link"
                                class="form-control @error('fb_link') is-invalid @enderror" value="{{ $team->fb_link }}"
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" name="x_link" id="x_link"
                                class="form-control @error('x_link') is-invalid @enderror" value="{{ $team->x_link }}"
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" name="linkedIn_link" id="linkedIn_link"
                                ...
                                value="{{ $team->linkedIn_link }}" aria-describedby="linkedIn_link">
